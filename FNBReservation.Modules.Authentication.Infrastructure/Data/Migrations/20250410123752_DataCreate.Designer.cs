...
namespace FNBReservation.Modules.Authentication.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250410123752_DataCreate")]
            ...
            modelBuilder.Entity("FNBReservation.Modules.Authentication.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a83b8f6d-a399-424a-952f-40e22cda75f0"),
                            CreatedAt = new DateTime(2025, 4, 10, 12, 37, 50, 479, DateTimeKind.Utc).AddTicks(4086),
                            ...
                            Role = "Admin",
                            UpdatedAt = new DateTime(2025, 4, 10, 12, 37, 50, 479, DateTimeKind.Utc).AddTicks(4089),
                            UserId = "ADMIN001",
                            Username = "admin"
                        });
                });
