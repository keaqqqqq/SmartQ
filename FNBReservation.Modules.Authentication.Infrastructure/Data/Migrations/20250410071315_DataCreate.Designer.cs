...
namespace FNBReservation.Modules.Authentication.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250410071315_DataCreate")]
            ...
            modelBuilder.Entity("FNBReservation.Modules.Authentication.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("113536cd-d160-4ba2-b81f-3d31104fe29c"),
                            CreatedAt = new DateTime(2025, 4, 10, 7, 13, 15, 361, DateTimeKind.Utc).AddTicks(9905),
                            ...
                            Role = "Admin",
                            UpdatedAt = new DateTime(2025, 4, 10, 7, 13, 15, 361, DateTimeKind.Utc).AddTicks(9908),
                            UserId = "ADMIN001",
                            Username = "admin"
                        });
                });
