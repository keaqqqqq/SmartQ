...
namespace FNBReservation.Modules.Authentication.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250315043141_AddStaffFieldsToExistingUsers")]
    partial class AddStaffFieldsToExistingUsers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FNBReservation.Modules.Authentication.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("37d299bb-08dc-4794-bcff-c05c8ab7f49b"),
                            CreatedAt = new DateTime(2025, 3, 15, 4, 31, 40, 890, DateTimeKind.Utc).AddTicks(2692),
                            ...
                            Role = "Admin",
                            UpdatedAt = new DateTime(2025, 3, 15, 4, 31, 40, 890, DateTimeKind.Utc).AddTicks(2693),
                            UserId = "ADMIN001",
                            Username = "admin"
                        });
                });
